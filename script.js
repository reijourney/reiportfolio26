...
function populateProjects() {
  ...
  projects.forEach(proj => {
    ...
    let imageHtml = '';
    if (proj.imageSrc) {
      imageHtml = `<img loading="lazy" decoding="async" src="${proj.imageSrc}" alt="Proyek ${proj.title}" class="w-full h-48 object-cover mb-4 rounded-md border border-stone-200" onerror="this.onerror=null;this.src='https://placehold.co/400x250/E2E8F0/A0AEC0?text=Tidak+Ada+Gambar';">`;
    }
